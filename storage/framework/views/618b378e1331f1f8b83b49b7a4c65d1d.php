...
<body>
  <div class="container">
    ...
    <div>
      <img src="<?php echo e(asset('storage/siswas/'.$siswa->image)); ?>" alt="Profile Picture" style="height: 150px; border-radius:30%; solid #ccc;" class="profile-img">
...
<?php /**PATH C:\laragon\www\epoinA-with-figma-version\resources\views/admin/siswa/show.blade.php ENDPATH**/ ?>