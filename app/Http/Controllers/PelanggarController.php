...
{  //validate form
    ...
    $this->updatePoin($request->id_pelanggaran, $request->id_pelanggar);
     ...
     //redirect to index
     return redirect()->route('detailPelanggar.show', $request->id_pelanggar)->with(['success' => 'Data Berhasil Ditambahkan!']);
}
...
function updateStatus($datas, string $poin)
{
    ...
    public function statusTindak($id)
    {
        ...
        $pelanggar = DB::table('pelanggars')
            ...
            return redirect()->route('pelanggar.index')->with(['success' => 'Data Berhasil Ditindak!']);
    }
